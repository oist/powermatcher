...
@Component(immediate = true,
           service = { AgentEndpoint.class, ObservableAgent.class, MatcherEndpoint.class })
@Designate(ocd = Concentrator.Config.class, factory = true)
public class Concentrator
    ...
    public @interface Config {
        @AttributeDefinition(defaultValue = "concentrator")
        String agentId();

        @AttributeDefinition(defaultValue = "auctioneer")
        String desiredParentId();

        @AttributeDefinition(defaultValue = "1000",
